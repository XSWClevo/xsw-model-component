...
import com.xshiwu.mapper.PostFavourMapper;
import com.xshiwu.mapper.PostMapper;
import com.xshiwu.mapper.PostThumbMapper;
...
import com.xshiwu.model.entity.PostFavour;
import com.xshiwu.model.entity.PostThumb;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public QueryWrapper<Post> getQueryWrapper(PostQueryRequest postQueryRequest) {
        ...
        if (StringUtils.isNotBlank(searchText)) {
            queryWrapper.like("title", searchText).or().like("content", content);
        }
